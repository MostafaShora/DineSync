...
export default function SidebarBefor() {
  return (
    ...
    <div className="flex flex-row items-center w-full h-[70px] px-2 lg:bg-[#EFE6D6]/70 lg:rounded-2xl lg:p-6 lg:flex-col lg:min-h-[calc(100vh-48px)]">
      ...
      {/* LOGO - يختفي تماماً في الموبايل عشان مياخدش مساحة */}
      ...
      {/* NAV - شريط التمرير الأفقي في الموبايل، وعمودي في الكمبيوتر */}
      <nav className="flex flex-row items-center gap-1 overflow-x-auto w-full [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] lg:flex-col lg:mt-8 lg:space-y-2 lg:overflow-visible">
        ...
        <button className="flex flex-col lg:flex-row items-center justify-center lg:justify-start gap-1 lg:gap-3 px-3 py-2 lg:px-4 lg:py-3 rounded-xl hover:bg-gray-50 lg:hover:bg-[#FBF7F0] min-w-[70px] lg:w-full lg:min-w-0 transition">
          <FiCoffee className="w-6 h-6 lg:w-5 lg:h-5 text-[#121212]" />
          <span className="text-[10px] lg:text-base text-[#121212]">Categories</span>
        </button>

        <button className="flex flex-col lg:flex-row items-center justify-center lg:justify-start gap-1 lg:gap-3 px-3 py-2 lg:px-4 lg:py-3 rounded-xl hover:bg-gray-50 lg:hover:bg-[#FBF7F0] min-w-[70px] lg:w-full lg:min-w-0 transition">
          <FiTrendingUp className="w-6 h-6 lg:w-5 lg:h-5 text-[#121212]" />
          <span className="text-[10px] lg:text-base text-[#121212] whitespace-nowrap">Popular</span>
        </button>

        <button className="flex flex-col lg:flex-row items-center justify-center lg:justify-start gap-1 lg:gap-3 px-3 py-2 lg:px-4 lg:py-3 rounded-xl hover:bg-gray-50 lg:hover:bg-[#FBF7F0] min-w-[70px] lg:w-full lg:min-w-0 transition">
          <FiStar className="w-6 h-6 lg:w-5 lg:h-5 text-[#121212]" />
          <span className="text-[10px] lg:text-base text-[#121212] whitespace-nowrap">Top Rated</span>
        </button>
        ...
        >
          ...
          <span className="text-[10px] lg:text-base text-[#121212]">Wish List</span>
        </Link>
        ...
        >
          ...
          <span className="text-[10px] lg:text-base text-[#121212] whitespace-nowrap">Nearby</span>
        </Link>
      </nav>

      {/* PROMO - يختفي في الموبايل */}
